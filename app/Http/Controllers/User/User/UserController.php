...
class UserController extends AdminBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.user.index')->with('success', trans('users/index.crud_messagedscreated'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user.user.index')->with('success', trans('users/index.crud_messages.edited'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user.user.index')->with('success', trans('users/index.crud_messages.removed'));
    }
}
