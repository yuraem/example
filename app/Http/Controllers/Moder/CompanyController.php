...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($user);
        return view('moder.company.index', compact('companys', 'user'));
    }
    ...
    {
        return view('moder.company.create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('moder.company.index')->with('success', __('Кампания успешно создана'));
    ...
    public function show($id)
    {
        ...
        $users = User::get();
        return view('moder.company.show', [
            'company' => $company,
            'users' => $users,            
        ]);
    }
    ...
    {
        $users = User::get();
        return view('moder.company.edit', [
            'company' => Companies::find(intval($id)),
            'users' => $users,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('moder.company.index')->with('success', __('Кампания успешно обновлена'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('moder.company.index')->with('success', __('Кампания успешно удалена'));
    }
}
