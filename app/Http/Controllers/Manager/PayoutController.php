...
class PayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$requestData) {
            dd($requestData);
            return redirect()->route('manager.payout.index')->with('success', __('Ошибка'));
        ...
        return redirect()->route('manager.payout.show', $request->user_id)->with('success', 'Платёж успешно создан');
    ...
    public function showBalance(Request $request, $id)
    {
        ...
        if($company->count() == 0){
            return redirect()->route('manager.index')->with('success', 'У пользователя нет кампаний !!!');
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manager.payout.show', $user_id)->with('success', 'Выплата удалена');
