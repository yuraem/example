...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.company.index', compact('companys', 'user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.company.index')->with('success', __('Кампания успешно создана'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('manager.company.index')->with('success', __('Кампания успешно обновлена'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manager.company.index')->with('success', __('Кампания успешно удалена'));
    }
}
