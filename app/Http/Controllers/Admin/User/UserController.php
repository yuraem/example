...
class UserController extends AdminBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.user.index')->with('success', trans('users/index.crud_messagedscreated'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.user.index')->with('success', trans('users/index.crud_messages.edited'));
    }
    ...
    { 
        ...
        if ($companies != null) {
            ...
            $dir =  base_path('public/analitiks/'.$companies['company_kt'].'/');
        ...
        return redirect()->route('admin.user.index')->with('success', trans('users/index.crud_messages.removed'));
    }
}
