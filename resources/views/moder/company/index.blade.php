              ...
              <tbody>                               
                  @foreach($companys as $company)
                      <tr>
                          ...
                          <td>{{ $company->geo }}</td>                                  
                          <td>
                              <a href="{{ route('user.company.show', $company->id)}}" class="btn btn-info btn-xs"><i class="fa fa-eye">&nbsp; {{__('Статистика')}}</i> </a>                              
                          </td>
                      </tr>
                  @endforeach
              </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="{{ route('user.company.destroy', 8)}}" method="post" id="deleteform">
                                @method('DELETE')
                                @csrf
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#deleteModal').on("show.bs.modal", function (e) {
                $("#deleteform").attr('action', '/user/company/' + $(e.relatedTarget).data('id'));
