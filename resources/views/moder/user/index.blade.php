      ...
      <div class="card">
        <div class="card-header">
          <!-- <h3 class="card-title">Responsive Hover Table</h3> -->
            <!-- <div class="pull-left"> -->
                  <a href="{{ route('moder.user.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Новый пользователь</a>
            <!-- </div> -->
            <!-- <div class="pull-right"> -->
            <div class="card-tools">  
                  <form action="{{ route('moder.user.index') }}" method="get">
              ...
              <tbody>                               
                  @foreach($users as $user)
                      <tr>
                          ...
                          <td>{{ $user->email }}</a></td>                                        
                          <td>
                              <a href="{{ route('moder.user.edit', $user->id)}}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a>
                              <button
                                  type="button"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="{{ route('moder.user.destroy', 8)}}" method="post" id="deleteform">
                                @method('DELETE')
                                @csrf
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#deleteModal').on("show.bs.modal", function (e) {
                $("#deleteform").attr('action', '/moder/user/' + $(e.relatedTarget).data('id'));
