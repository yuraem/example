    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
           <form action="{{ route('manager.statistics.showStat', $company->id)}}" method="post" >                               
                @csrf    
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <input type="hidden" name="daterange" class="form-control float-right" id="reservationtime" value="{{ $date_from ?? ''}}/{{  $date_to  ?? ''}}">
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">                      
                        <span class="daterange_text">{{ $date_from ?? ''}} / {{  $date_to  ?? ''}}</span>
                    </div>
                  </div>
                </div>
