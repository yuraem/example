    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.payout.showStat', $user->id)}}" method="post" >                               
                @csrf          
          ...
          <form action="{{ route('admin.payout.store') }}" method="POST" enctype="application/json" >
            @csrf  @method('POST') 
                  @include('admin.payout.form', ['user' => $user, 'payouts' => $payouts])                    
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#deleteModal').on("show.bs.modal", function (e) {
                $("#deleteform").attr('action', '/admin/payout/' + $(e.relatedTarget).data('id'));
