        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                        ...
                        @method('PUT')
                            <div class="card-body">
                                @include('admin.company.form', ['company' => $company])                    
                            </div>  
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                        ...
                        <div>
                            Проверить ссылку 1<a href="{{ getenv('APP_URL') }}/analitiks/{{ $company->company_kt }}/index.js" target="_blank">
                                {{ getenv('APP_URL') }}/analitiks/{{ $company->company_kt }}/index.js
                            </a>
                        </div>
                        <div>
                            Проверить ссылку 2<a href="{{ getenv('APP_URL') }}/analitiks/{{ $company->company_kt }}/thanks.js" target="_blank">
                                {{ getenv('APP_URL') }}/analitiks/{{ $company->company_kt }}/thanks.js
                            </a>
                        </div>
                </div> 
            </div> 
