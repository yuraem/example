    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('user.statistics.index')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('user.payout.index') }}" class="nav-link">
              <i class="nav-icon fas fa-tags"></i>
              <p>
                Выплаты               
              </p>
          ...
          <li class="nav-item">
            <a href="{{ route('user.profil.index')}}" class="nav-link">
          ...
          <li class="nav-item">
          <a href="{{ route('user.payout.showBalance', Auth::user()->id ) }}" class="nav-link">
