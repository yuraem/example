    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('user.payout.showStat', $user->id)}}" method="post" >                               
                @csrf          
          ...
          <form action="{{ route('user.payout.store') }}" method="POST" enctype="application/json" >
            @csrf  @method('POST') 
                  @include('user.payout.form', ['user' => $user, 'payouts' => $payouts])                    
